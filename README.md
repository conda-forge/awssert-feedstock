...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/awssert-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12960&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/awssert-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `awssert` can be installed with:

```
conda install awssert
```

It is possible to list all of the versions of `awssert` available on your platform with:
